...
var module = angular.module('home_automation', []);
    ...
    module.controller('homeController', ['$scope', 'homeService', function($scope, homeService){
        ...
        //We are reading the current temperature from a server (temp.json file in this case)
		...
		//Added all the values in Local Storage for future usage
		localStorage.setItem("light1", $scope.room.room_1.lights);
		...
		localStorage.setItem("light2", $scope.room.room_2.lights);
        ...
        $("#room1Increase").on("click", function() {
			...
			localStorage.setItem("room1_temp", $scope.roomTemp.room_1.temperature);
            $scope.$apply();
        ...
        $("#room2Increase").on("click", function() {
			...
			localStorage.setItem("room2_temp", $scope.roomTemp.room_2.temperature);
            $scope.$apply();
